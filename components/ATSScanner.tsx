...
export default function ATSScanner() {
  ...
  const downloadReport = () => {
    ...
    const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>ATS Report — Shyam Pro Services</title><style>
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      <div class="header">
        <div><div class="brand">Shyam Pro <span>Services</span></div><div style="font-size:12px;color:#888;margin-top:2px">ATS Resume Scan Report</div></div>
      ...
      <div class="footer">Generated by <a href="https://procareerservices.vercel.app">Shyam Pro Services</a> · ${date} · Not for redistribution</div>
    </body></html>`;
