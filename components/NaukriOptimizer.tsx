...
export default function NaukriOptimizer() {
  ...
  const handleDownloadNaukriReport = () => {
    ...
    try {
      ...
      const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Naukri Optimization Report — Shyam Pro Services</title><style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        <div class="header">
          <div><div class="brand">Naukri Profile Optimization Report</div><div style="font-size:12px;color:#888;margin-top:3px">by Shyam Pro Services</div></div>
        ...
        <div class="footer">Generated by <a href="https://procareerservices.vercel.app">Shyam Pro Services</a> · ${date} · Implement these changes within 48 hours for best results</div>
      </body></html>`;
